...
3. Renders HTML:
   ...
   - Individual page detail pages with backlinks
...
5. Writes `style.css` and `script.js` (theme toggle, search palette)
...
Three regex patterns extract references from page bodies:
